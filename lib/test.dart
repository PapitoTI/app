...
class _LoginAppState extends State<LoginApp> {
      ...
      home: Scaffold(
        ...
        child: FutureBuilder(
            ...
            builder: (BuildContext context,
                AsyncSnapshot<TouristServerConnectionInterface> snapshot) {
  ...
  Widget loginForm(String? info) => ListView(
      children: [
            Text("Email"),
            TextField(
            ...
            TextButton(
                onPressed: () => {
                      setState(() {
                        _future = _builder.connectTourist(Credentials(
  ...
  Widget registerForm(String? info) => ListView(
      children: [
            ...
            TextButton(
                onPressed: () => {
                      setState(() {
                        _future = _reg.registerTourist(emailController.text,
